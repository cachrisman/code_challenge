class UsersController < ApplicationController
  before_action :set_user, only: [:show, :edit, :update, :destroy, :generate_token]
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:name, :email, :receive_marketing, :receive_articles, :receive_digest)
    end
end
